...
#include "../plain/my_basic_algorithm_plain.h"  // for MY_BASIC_ALGORITHM_PARAMS
...
class MY_BASIC_ALGORITHM_TFHE : public TFHECipher {
 public:
  typedef My_Basic_Algorithm Plain;
  MY_BASIC_ALGORITHM_TFHE(std::vector<uint8_t> secret_key, int seclevel = 128)
      : TFHECipher(MY_BASIC_ALGORITHM_PARAMS, secret_key, seclevel) {}

  virtual ~MY_BASIC_ALGORITHM_TFHE() = default;

  virtual std::string get_cipher_name() const { return "MY-BASIC-ALGORITHM-TFHE"; }
